...
const HomePage = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50/50 to-indigo-50 dark:from-slate-900 dark:via-indigo-950/50 dark:to-purple-950 transition-all duration-500">
      {/* Header */}
      <header className="bg-white/95 dark:bg-gray-900/95 backdrop-blur-md shadow-lg border-b border-gray-200 dark:border-gray-700 sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 relative">
          <div className="flex items-center justify-between">
            ...
            <div className="sm:hidden absolute top-6 left-16 z-[60]">
              <ThemeToggle />
            </div>
          </div>
        </div>
      ...
      <section className="relative bg-gradient-to-br from-blue-600 via-indigo-700 to-purple-800 dark:from-blue-800 dark:via-indigo-900 dark:to-purple-900 text-white py-16 md:py-20 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="animate-fadeInUp">
            ...
            <p className="text-lg md:text-xl lg:text-2xl mb-8 text-blue-100 max-w-4xl mx-auto leading-relaxed px-4 select-none">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            <button onClick={scrollToGrades} className="group bg-gradient-to-br from-blue-50 to-blue-100 dark:from-blue-900/20 dark:to-blue-800/20 rounded-2xl p-8 border border-blue-200 dark:border-blue-700 hover:shadow-2xl transform hover:-translate-y-2 transition-all duration-500 relative overflow-hidden">
              {/* Limited Offer Badge - fixed, left side to match other */}
              <div className="absolute top-3 left-3 bg-gradient-to-r from-red-600 to-pink-600 text-white px-5 py-1.5 rounded-full text-sm font-extrabold shadow-2xl z-10 border border-white/50">
                🔥 عرض محدود
              </div>
              <div className="text-center">
      ...
      <section id="features-section" className="py-16 bg-white dark:bg-gray-800 transition-colors duration-300">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-4">الأسئلة الشائعة - الضمان و ثقتنا</h2>
            <p className="text-lg text-gray-600 dark:text-gray-300">أسئلة وأجوبة مختصرة لبناء الثقة</p>
          </div>
