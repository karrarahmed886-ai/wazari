...
import { ArrowRight, Eye, Check, X, Clock, Search, Filter, Trash2 } from "lucide-react";
      ...
      <header className="bg-white/95 dark:bg-gray-900/95 backdrop-blur-md shadow-sm border-b border-gray-200 dark:border-gray-700">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex items-center justify-between">
            ...
            <h1 className="text-2xl font-bold text-gray-900 dark:text-white">لوحة إدارة الطلبات</h1>
            <ThemeToggle />
          </div>
        </div>
      </header>
